        ...
        function updateOnlineStatus() {
            ...
            chatWindow.prototype.init = function () {
                ...
                if(!me.config.minimizeMode){
                    ...
                    chatWindowHtml.find('.minimized-title').html("Hablame, yo puedo ayudarte");
                    me.skipedInit=true;
            ...
            chatWindow.prototype.bindEvents = function () {
                ...
                _chatContainer.off('click', '.minimize-btn').on('click', '.minimize-btn', function (event) {
                    ...
                    if (me.minimized === true) {
                        ...
                        _chatContainer.find('.minimized-title').html("Hablame, yo puedo ayudarte");
                        me.minimized = true;
                        if (me.expanded === true) {
                            $('.kore-chat-overlay').hide();
                        }
